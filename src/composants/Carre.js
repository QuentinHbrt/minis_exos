...
class Carre extends React.Component {
  constructor(props) {
    ...
    // Attention à la synthaxe si il y a plusieurs états pour un seul composant
    this.state = { 
        isCarreVisible: true,
        isCarreRed: false
    };
    ...
    this.handleCarreRedCLick = this.handleCarreRedCLick.bind(this);
  ...
  render() {
    ...
    if (isCarreRed === true) {
        toutesLesClassesDuCarre = "carre red";
    }
    ...
    return (
          <div>
            ...
            <button onClick={this.handleCarreRedCLick}>rouge</button>
            <button>bleu</button>
          </div>
    );
  }
